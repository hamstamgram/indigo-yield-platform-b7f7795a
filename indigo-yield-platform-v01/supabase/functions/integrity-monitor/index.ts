  ...
  const blocks = [
    ...
    })),
    {
      ...
      elements: [
        {
          type: "mrkdwn",
          text: `Checked at ${new Date().toISOString()} | <https://app.indigofund.com/admin/integrity|View Dashboard>`,
        },
      ],
    },
  ];
...
async function sendEmailAlert(supabase: any, email: string, results: CheckResult[]): Promise<void> {
  ...
  const htmlContent = `
    ...
    <p><a href="https://app.indigofund.com/admin/integrity">View Dashboard</a></p>

  ...
  public: {
    ...
    Views: {
      v_crystallization_dashboard: {
        Row: {
          ...
          crystallized_count: number | null;
      ...
      v_crystallization_gaps: {
        Row: {
          ...
          days_since_crystallization: number | null;
          current_value: number | null;
        };
        Insert: {
          investor_id?: string | null;
      ...
      v_duplicate_transactions: {
        Row: {
          ...
          types: Database["public"]["Enums"]["tx_type"][] | null;
        };
        Relationships: [];
      };
      ...
      v_ledger_position_mismatches: {
        Row: {
          ...
          fund_id: string | null;
          investor_id: string | null;
          ledger_deposits: number | null;
          ledger_yield: number | null;
          position_value: number | null;
          status: string | null;
        };
        Relationships: [
      ...
      v_liquidity_risk: {
        Row: {
          ...
          withdrawal_pressure_pct: number | null;
        };
        Relationships: [];
      };
      ...
      v_position_ledger_reconciliation: {
        Row: {
      ...
      v_yield_conservation_check: {
        ...
        Insert: {
          calculated_total?: never;
          conservation_status?: never;
          created_at?: string | null;
          dust_amount?: never;
          effective_date?: string | null;
          fund_id?: string | null;
      ...
      v_yield_conservation_violations: {
        Row: {
          distribution_fees: number | null;
          distribution_gross: number | null;
          distribution_id: string | null;
          distribution_net: number | null;
          dust_amount: number | null;
          effective_date: string | null;
          events_fees: number | null;
          events_gross: number | null;
          events_net: number | null;
          fees_diff: number | null;
          fund_code: string | null;
          fund_id: string | null;
    ...
    Functions: {
      ...
      batch_crystallize_fund: {
        Args: { p_fund_id: string; p_dry_run?: boolean };
        Returns: Json;
      };

...
export function OpenPeriodDialog({ open, onOpenChange, fund, onSuccess }: OpenPeriodDialogProps) {
  ...
  const formatValue = (value: number | undefined | null, asset: string) => {
    const safeValue = value ?? 0;
    if (asset === "BTC") {
      return safeValue.toLocaleString("en-US", { minimumFractionDigits: 4, maximumFractionDigits: 8 });
    } else if (asset === "ETH" || asset === "SOL") {
      return safeValue.toLocaleString("en-US", { minimumFractionDigits: 2, maximumFractionDigits: 6 });
    }
    return safeValue.toLocaleString("en-US", { minimumFractionDigits: 2, maximumFractionDigits: 4 });
  };
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder={fund ? String(fund.total_aum ?? 0) : "Enter baseline AUM"}
              className="font-mono"
            />

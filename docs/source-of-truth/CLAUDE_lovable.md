...
# Run yield-specific integration tests (45 tests)
...
npx supabase generate types

# Check database schema hygiene
npm run sql:hygiene
```
...
# Verify gateway usage (ensure no direct supabase calls from components)

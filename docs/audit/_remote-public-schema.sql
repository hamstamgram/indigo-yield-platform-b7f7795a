...
CREATE OR REPLACE FUNCTION "public"."adjust_investor_position"("p_fund_id" "uuid", "p_investor_id" "uuid", "p_amount" numeric, "p_tx_date" "date", "p_reason" "text", "p_admin_id" "uuid" DEFAULT NULL::"uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."adjust_investor_position"("p_fund_id" "uuid", "p_investor_id" "uuid", "p_amount" numeric, "p_tx_date" "date", "p_reason" "text", "p_admin_id" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."apply_investor_transaction"("p_fund_id" "uuid", "p_investor_id" "uuid", "p_tx_type" "public"."tx_type", "p_amount" numeric, "p_tx_date" "date", "p_reference_id" "text", "p_admin_id" "uuid", "p_notes" "text" DEFAULT NULL::"text", "p_purpose" "public"."aum_purpose" DEFAULT 'transaction'::"public"."aum_purpose", "p_distribution_id" "uuid" DEFAULT NULL::"uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
BEGIN
  ...
  -- Delegate to 11-arg version with swapped order
  RETURN apply_investor_transaction(
    p_investor_id, p_fund_id, p_tx_type::text, p_amount, p_tx_date,
    p_reference_id, p_notes, v_admin, p_purpose, p_distribution_id, NULL
  );
END;
$$;


ALTER FUNCTION "public"."apply_investor_transaction"("p_fund_id" "uuid", "p_investor_id" "uuid", "p_tx_type" "public"."tx_type", "p_amount" numeric, "p_tx_date" "date", "p_reference_id" "text", "p_admin_id" "uuid", "p_notes" "text", "p_purpose" "public"."aum_purpose", "p_distribution_id" "uuid") OWNER TO "postgres";
...
BEGIN
  ...
  -- Admin check with override
  IF NOT is_admin(v_admin) THEN
    RAISE EXCEPTION 'Unauthorized: admin role required';
  END IF;
  
  -- Auto-crystallization disabled check
  IF p_new_total_aum IS NOT NULL THEN
    RAISE EXCEPTION 'Auto-crystallization is disabled. Pass p_new_total_aum = NULL.';
  END IF;
  ...
  RETURN jsonb_build_object(
    ...
    'post_transaction_aum', v_post_aum, 'is_new_investor', v_is_new_investor
  );
END;
$$;
...
BEGIN
  ...
  -- Populate with current balances AND pre-day balances.
  -- pre_day_value = current_value minus any same-day deposit/withdrawal amounts.
  -- This excludes investors who deposited today from receiving yield.
  ...
  FOR v_alloc IN SELECT * FROM _vflat_alloc LOOP
    ...
    -- YIELD transaction for this investor
    ...
    -- Set admin_only visibility for fees_account YIELD txs
    IF v_alloc.account_type = 'fees_account' THEN
  ...
  -- Safe UPDATE-then-INSERT for fund_daily_aum
  UPDATE fund_daily_aum
...
CREATE OR REPLACE FUNCTION "public"."set_account_type_for_ib"("p_user_id" "uuid") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
BEGIN
  UPDATE profiles SET account_type = 'ib'::account_type WHERE id = p_user_id;
END;
$$;


ALTER FUNCTION "public"."set_account_type_for_ib"("p_user_id" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."void_and_reissue_full_exit"("p_transaction_id" "uuid", "p_new_amount" numeric, "p_admin_id" "uuid", "p_reason" "text", "p_send_precision" integer DEFAULT 3, "p_new_date" "date" DEFAULT NULL::"date") RETURNS json
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."void_and_reissue_full_exit"("p_transaction_id" "uuid", "p_new_amount" numeric, "p_admin_id" "uuid", "p_reason" "text", "p_send_precision" integer, "p_new_date" "date") OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."_fee_schedule_backup" (
    "id" "uuid",
    "investor_id" "uuid",
    "fund_id" "uuid",
    "effective_date" "date",
...
ALTER TABLE "public"."_fee_schedule_backup" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."_fund_aum_backup" (
    "id" "uuid",
    "aum_date" "date",
    "total_aum" numeric,
    ...
    "voided_by" "uuid",
    "void_reason" "text",
    "temporal_lock_bypass" boolean,
    "voided_by_profile_id" "uuid"
);


ALTER TABLE "public"."_fund_aum_backup" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."_funds_backup" (
    "id" "uuid",
    "code" "text",
    "name" "text",
    "asset" "text",
    ...
    "max_daily_yield_pct" numeric(6,4),
    "min_withdrawal_amount" numeric(20,8)
);


ALTER TABLE "public"."_funds_backup" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."_ib_schedule_backup" (
    "id" "uuid",
    "investor_id" "uuid",
    "fund_id" "uuid",
    "effective_date" "date",
    "end_date" "date",
    "ib_percentage" numeric(5,2),
    "created_at" timestamp with time zone,
    "updated_at" timestamp with time zone
);


ALTER TABLE "public"."_ib_schedule_backup" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."_positions_backup" (
    "fund_id" "uuid",
...
ALTER TABLE "public"."_positions_backup" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."_profiles_backup" (
    "id" "uuid",
    "email" "text",
    "first_name" "text",
    "last_name" "text",
...
ALTER TABLE "public"."_profiles_backup" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."_transactions_backup" (
    "id" "uuid",
    "fund_id" "uuid",
    "tx_date" "date",
    "value_date" "date",
...
ALTER TABLE "public"."_transactions_backup" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."_user_roles_backup" (
    "id" "uuid",
    "user_id" "uuid",
...
ALTER TABLE "public"."_user_roles_backup" OWNER TO "postgres";
...
REVOKE ALL ON FUNCTION "public"."adjust_investor_position"("p_fund_id" "uuid", "p_investor_id" "uuid", "p_amount" numeric, "p_tx_date" "date", "p_reason" "text", "p_admin_id" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."adjust_investor_position"("p_fund_id" "uuid", "p_investor_id" "uuid", "p_amount" numeric, "p_tx_date" "date", "p_reason" "text", "p_admin_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."adjust_investor_position"("p_fund_id" "uuid", "p_investor_id" "uuid", "p_amount" numeric, "p_tx_date" "date", "p_reason" "text", "p_admin_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."apply_investor_transaction"("p_fund_id" "uuid", "p_investor_id" "uuid", "p_tx_type" "public"."tx_type", "p_amount" numeric, "p_tx_date" "date", "p_reference_id" "text", "p_admin_id" "uuid", "p_notes" "text", "p_purpose" "public"."aum_purpose", "p_distribution_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."apply_investor_transaction"("p_fund_id" "uuid", "p_investor_id" "uuid", "p_tx_type" "public"."tx_type", "p_amount" numeric, "p_tx_date" "date", "p_reference_id" "text", "p_admin_id" "uuid", "p_notes" "text", "p_purpose" "public"."aum_purpose", "p_distribution_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."apply_investor_transaction"("p_fund_id" "uuid", "p_investor_id" "uuid", "p_tx_type" "public"."tx_type", "p_amount" numeric, "p_tx_date" "date", "p_reference_id" "text", "p_admin_id" "uuid", "p_notes" "text", "p_purpose" "public"."aum_purpose", "p_distribution_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."set_account_type_for_ib"("p_user_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."set_account_type_for_ib"("p_user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."set_account_type_for_ib"("p_user_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."void_and_reissue_full_exit"("p_transaction_id" "uuid", "p_new_amount" numeric, "p_admin_id" "uuid", "p_reason" "text", "p_send_precision" integer, "p_new_date" "date") TO "anon";
GRANT ALL ON FUNCTION "public"."void_and_reissue_full_exit"("p_transaction_id" "uuid", "p_new_amount" numeric, "p_admin_id" "uuid", "p_reason" "text", "p_send_precision" integer, "p_new_date" "date") TO "authenticated";
GRANT ALL ON FUNCTION "public"."void_and_reissue_full_exit"("p_transaction_id" "uuid", "p_new_amount" numeric, "p_admin_id" "uuid", "p_reason" "text", "p_send_precision" integer, "p_new_date" "date") TO "service_role";
...
GRANT ALL ON TABLE "public"."_fee_schedule_backup" TO "anon";
GRANT ALL ON TABLE "public"."_fee_schedule_backup" TO "authenticated";
GRANT ALL ON TABLE "public"."_fee_schedule_backup" TO "service_role";



GRANT ALL ON TABLE "public"."_fund_aum_backup" TO "anon";
GRANT ALL ON TABLE "public"."_fund_aum_backup" TO "authenticated";
GRANT ALL ON TABLE "public"."_fund_aum_backup" TO "service_role";



GRANT ALL ON TABLE "public"."_funds_backup" TO "anon";
GRANT ALL ON TABLE "public"."_funds_backup" TO "authenticated";
GRANT ALL ON TABLE "public"."_funds_backup" TO "service_role";



GRANT ALL ON TABLE "public"."_ib_schedule_backup" TO "anon";
GRANT ALL ON TABLE "public"."_ib_schedule_backup" TO "authenticated";
GRANT ALL ON TABLE "public"."_ib_schedule_backup" TO "service_role";



GRANT ALL ON TABLE "public"."_positions_backup" TO "anon";
GRANT ALL ON TABLE "public"."_positions_backup" TO "authenticated";
GRANT ALL ON TABLE "public"."_positions_backup" TO "service_role";



GRANT ALL ON TABLE "public"."_profiles_backup" TO "anon";
GRANT ALL ON TABLE "public"."_profiles_backup" TO "authenticated";
GRANT ALL ON TABLE "public"."_profiles_backup" TO "service_role";



GRANT ALL ON TABLE "public"."_transactions_backup" TO "anon";
GRANT ALL ON TABLE "public"."_transactions_backup" TO "authenticated";
GRANT ALL ON TABLE "public"."_transactions_backup" TO "service_role";



GRANT ALL ON TABLE "public"."_user_roles_backup" TO "anon";
GRANT ALL ON TABLE "public"."_user_roles_backup" TO "authenticated";
GRANT ALL ON TABLE "public"."_user_roles_backup" TO "service_role";

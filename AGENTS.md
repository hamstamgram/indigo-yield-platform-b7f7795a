...
- **2026-04-16**: Tier 4 — `20260416160000_security_tier4_read_gates.sql` (5 ungated SECDEF read function gates: get_investor_fee_pct, get_investor_ib_pct via can_access_investor; get_system_mode via is_admin; get_user_admin_status via self-or-admin; _resolve helpers gated + anon revoked)
- **2026-04-16**: Tier 3.5 — `20260416150000_security_tier35_cross_tenant_gaps.sql` (3 cross-tenant read gap fixes + anon grant revocations)

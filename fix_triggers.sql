-- Drop the obsolete trigger and its function
DROP FUNCTION IF EXISTS public.ensure_crystallization_date() CASCADE;

-- Patch trg_ledger_sync function to remove the crystallization metadata update
CREATE OR REPLACE FUNCTION "public"."trg_ledger_sync"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
  v_aum_purpose public.aum_purpose;
BEGIN

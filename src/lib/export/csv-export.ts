  ...
  static createPortfolioExportConfig(): ExportOptions {
    return {
      ...
      columns: [
        ...
        { key: 'percentOfPortfolio', label: '% of Portfolio', format: (v) => `${parseFloat(v).toFixed(2)}%` },
  ...
  static createTransactionsExportConfig(): ExportOptions {
    return {
      ...
      columns: [
        ...
        { key: 'balance', label: 'Balance', format: (v) => v ? `$${parseFloat(v).toFixed(2)}` : '' },
  ...
  static createBalancesExportConfig(): ExportOptions {
    return {
      ...
      columns: [
        ...
        { key: 'cash_balance', label: 'Cash Balance', format: (v) => `$${parseFloat(v).toFixed(2)}` },
        { key: 'invested_amount', label: 'Invested Amount', format: (v) => `$${parseFloat(v).toFixed(2)}` },
        { key: 'unrealized_pnl', label: 'Unrealized P&L', format: (v) => `$${parseFloat(v).toFixed(2)}` },
        { key: 'total_return_percent', label: 'Total Return %', format: (v) => `${parseFloat(v).toFixed(2)}%` },

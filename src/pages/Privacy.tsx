      ...
      <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-12 max-w-4xl">
        ...
        <div className="prose prose-indigo max-w-none">
          ...
          <p className="text-muted-foreground mb-4">
            At INDIGO DIGITAL ASSETS YIELD, we take your privacy seriously. This Privacy Policy
          ...
          <p className="text-muted-foreground mb-4">
            ...
            <br />
            <br />
            <strong>Financial Information:</strong> Investment amounts, transaction history, and
            account balances necessary to provide our services.
            <br />
            <br />
          ...
          <p className="text-muted-foreground mb-4">
            ...
            <br />- Comply with legal obligations and prevent fraudulent activity
          </p>
          ...
          <p className="text-muted-foreground mb-4">
            ...
            <br />
            - Financial institutions and partners necessary to complete transactions
            <br />
            - Legal authorities when required by law or to protect our rights
            <br />- Business partners, with your consent, for marketing purposes
          </p>
          ...
          <p className="text-muted-foreground mb-4">
            ...
            <br />- Receive your data in a portable format
          </p>
          ...
          <h2 className="text-xl sm:text-2xl font-bold mt-6 sm:mt-8 mb-3 sm:mb-4">8. Contact Us</h2>
          <p className="text-muted-foreground mb-4">

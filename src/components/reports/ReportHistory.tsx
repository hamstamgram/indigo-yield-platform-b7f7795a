 ...
 * Custom report history feature is not yet available.
 */
      ...
      <CardContent>
        <div className="text-center py-12">
          ...
          <p className="text-muted-foreground">
            Custom report history is not yet available. Use the Statements section to generate investor statements.
          </p>
        </div>
      </CardContent>
    </Card>

  ...
  return (
    <div className="space-y-6">
      ...
      <Alert>
        ...
        <AlertDescription>
          Complete your profile to personalize your Indigo Yield experience. 
          This information helps us provide better service and secure your account.
        </AlertDescription>
      </Alert>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm">
              ...
              <p className="text-blue-700 dark:text-blue-300">
                Your personal information is encrypted and securely stored. We never share 
                your data with third parties without your consent. You can update this 

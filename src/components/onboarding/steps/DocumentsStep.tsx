...
const DocumentsStep: React.FC<DocumentsStepProps> = ({
  ...
  const [finalAcknowledgment, setFinalAcknowledgment] = useState(data.documents_acknowledged || false);
  ...
  const validateStep = () => {
    ...
    const allRequiredAcknowledged = requiredDocs.every(doc => 
      acknowledgedDocuments.has(doc.id)
    );
  ...
  const acknowledgedRequiredCount = REQUIRED_DOCUMENTS
    .filter(doc => doc.required && acknowledgedDocuments.has(doc.id))
    .length;
    ...
    <div className="space-y-6">
      ...
      <Alert>
        ...
        <AlertDescription>
          ...
          These contain important information about your investment.
        </AlertDescription>
      </Alert>
      ...
      <Card className="border-blue-200 bg-blue-50 dark:bg-blue-950 dark:border-blue-800">
        <CardContent className="pt-6">
          <div className="flex items-center justify-between">
            ...
            <Badge variant={acknowledgedRequiredCount === requiredDocsCount ? "default" : "secondary"}>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-green-700 dark:text-green-300">
                    You have successfully reviewed all required documents. 
                    Please provide your final acknowledgment below.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-2 pt-4 border-t border-green-200 dark:border-green-800">
                ...
                >
                  ...
                  the terms and conditions outlined in the documents above. I understand 
                  the risks involved and wish to proceed with my investment in Indigo Yield funds.
                </label>
              </div>
            </div>
          </CardContent>
      ...
      {acknowledgedRequiredCount < requiredDocsCount && (
        <Alert variant="destructive">
          ...
          <AlertDescription>
            You must review and acknowledge all required documents before proceeding to the next step.
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                If you have questions about any of these documents, please contact our 
                support team at{' '}

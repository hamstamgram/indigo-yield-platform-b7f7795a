      ...
      <CardHeader>
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button variant="outline" size="sm" onClick={() => exportFeesToCSV(fees)} disabled={fees.length === 0}>
      ...
      <CardContent>
                  ...
                  <TableRow key={fee.id}>
                    ...
                    <TableCell className="text-right font-mono">
                      <span className={fee.amount > 0 ? "text-emerald-600" : ""}>
                        {fee.amount > 0 ? "+" : ""}{formatFeeAmount(fee.amount, fee.asset)}
                      </span>
        ...
        {fees.length > 0 && (
          <p className="text-xs text-muted-foreground mt-2 text-right">
            Showing {fees.length} of {totalCount} total transactions
          </p>
        )}
      </CardContent>
    </Card>

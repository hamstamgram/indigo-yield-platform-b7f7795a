...
const AdminStatementGenerator: React.FC = () => {
  ...
  const handleGenerateStatements = () => {
    toast({
      ...
      description:
        "Statement generation is being updated for the new database schema. Please check back soon.",
      variant: "destructive",
    });
  };
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <select className="w-full p-2 border rounded-md opacity-50" disabled>
        ...
        <Button onClick={handleGenerateStatements} disabled className="w-full">

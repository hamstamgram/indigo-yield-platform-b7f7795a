...
import { Button, Card, CardContent, Tooltip, TooltipContent, TooltipTrigger } from "@/components/ui";
          ...
          {QUICK_ACTIONS.map((action) => (
            <Tooltip key={action.id}>
              <TooltipTrigger asChild>
                <Button
                  variant={action.variant === "primary" ? "primary" : action.variant === "warning" ? "outline" : "secondary"}
                  size="sm"

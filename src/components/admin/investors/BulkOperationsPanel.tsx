    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Import investor positions from CSV file
          </CardDescription>
        </CardHeader>
          ...
          {importResult && (
            <Alert variant={importResult.success ? "default" : "destructive"}>
              ...
              <AlertDescription>
                <div className="space-y-2">
                  <p>
                    <strong>Processed:</strong> {importResult.processed} | 
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Apply balance adjustments to multiple investors at once
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Alert>
            <AlertCircle className="h-4 w-4" />
            <AlertDescription>
              Bulk adjustments should be used with caution. All changes are logged for audit purposes.
              Use the CSV import feature above for complex bulk operations.
            </AlertDescription>
          </Alert>
        </CardContent>
      </Card>

  ...
  static createPortfolioExportConfig(): ExportOptions {
    return {
      ...
      columns: [
        ...
        { key: "quantity", label: "Quantity", format: (v) => parseFinancial(v).toFixed(4) },
        { key: "price", label: "Price (per unit)", format: (v) => parseFinancial(v).toFixed(6) },
        { key: "value", label: "Value", format: (v) => parseFinancial(v).toFixed(2) },
        {
          key: "percentOfPortfolio",
          label: "% of Portfolio",
          format: (v) => `${parseFinancial(v).toFixed(2)}%`,
        },
  ...
  static createTransactionsExportConfig(): ExportOptions {
    return {
      ...
      columns: [
        ...
        { key: "amount", label: "Amount", format: (v) => parseFinancial(v).toFixed(4) },
        {
          key: "balance",
          label: "Balance",
          format: (v) => (v ? parseFinancial(v).toFixed(4) : ""),
        },
    ...
    return {
      ...
      columns: [
        ...
        { key: "asset_code", label: "Asset" },
        {
          key: "total_value",
          label: "Total Value",
          format: (v) => parseFinancial(v).toFixed(4),
        },
        {
          key: "cash_balance",
          label: "Cash Balance",

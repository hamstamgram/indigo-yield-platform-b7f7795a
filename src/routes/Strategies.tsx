      ...
      <div className="container mx-auto px-6 py-12 max-w-4xl">
        ...
        <div className="prose prose-indigo max-w-none">
          <p className="text-lg text-gray-600 mb-6">
            At INDIGO DIGITAL ASSETS YIELD, we employ sophisticated strategies designed to generate
            sustainable yields across market cycles. Our approach combines traditional financial
            principles with cutting-edge blockchain opportunities.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-8 my-10">
            <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-xl p-8 border border-indigo-100">
              ...
              <p className="text-gray-600">
                We allocate capital across multiple yield strategies to minimize concentration risk
                and optimize for consistent returns through varying market conditions.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-xl p-8 border border-indigo-100">
              ...
              <p className="text-gray-600">
                Every strategy undergoes rigorous risk assessment, with continuous monitoring and
                predefined risk parameters to protect capital.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-8">
            <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
              ...
              <div className="p-6">
                <p className="text-gray-600 mb-4">
                  Our secured lending strategy provides capital to institutional borrowers, backed
                  by high-quality collateral with conservative loan-to-value ratios.
                </p>
            ...
            <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
              ...
              <div className="p-6">
                <p className="text-gray-600 mb-4">
                  We provide liquidity to leading decentralized exchanges and automated market
                  makers, generating yields from transaction fees while actively managing
            ...
            <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
              ...
              <div className="p-6">
                <p className="text-gray-600 mb-4">
                  We participate in securing leading proof-of-stake networks through staking and
                  delegation, generating native token yield while supporting network security.
                </p>
                <h4 className="font-semibold text-gray-900 mb-2">Key Features:</h4>
                <ul className="list-disc pl-5 text-gray-600 space-y-1">
            ...
            <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
              ...
              <div className="p-6">
                <p className="text-gray-600 mb-4">
                  We design and deploy structured yield products that combine multiple strategies to
                  create optimized risk-return profiles for specific market conditions.
                </p>
                <h4 className="font-semibold text-gray-900 mb-2">Key Features:</h4>
                <ul className="list-disc pl-5 text-gray-600 space-y-1">
          ...
          <p className="text-gray-600 mb-6">
            Our yield funds are constructed with careful consideration of strategy correlation,
            market cycles, and client risk preferences. We allocate capital dynamically in response
            to changing market conditions while maintaining our core risk management principles.
          </p>
          ...
          <div className="bg-gray-50 p-8 rounded-xl border border-gray-200 my-8">
            ...
            <ol className="list-decimal pl-5 text-gray-600 space-y-3">
              <li>
                <strong>Opportunity Identification:</strong> Continuous research to identify optimal
                yield opportunities across the digital asset ecosystem.
              </li>
              <li>
                <strong>Risk Assessment:</strong> Comprehensive evaluation of counterparty,
                technical, market, and liquidity risks.
              </li>
              <li>
                <strong>Due Diligence:</strong> Technical audits, counterparty verification, and
                security analysis.
              </li>
              <li>
                <strong>Position Sizing:</strong> Determination of optimal exposure based on risk
                parameters and return potential.
              </li>
              <li>
                <strong>Ongoing Monitoring:</strong> 24/7 monitoring of positions with defined risk
                thresholds and exit strategies.
              </li>
            </ol>
          </div>
        </div>

  ...
  public: {
    ...
    Functions: {
      ...
      check_aum_reconciliation: {
        Args: { p_as_of_date?: string; p_fund_id: string; p_tolerance?: number };
        Returns: Json;
      };
      ...
      get_drift_summary: {
        Args: never;
        Returns: {
          aum_drift_count: number;
          position_drift_count: number;
      ...
      get_fund_positions_sum: { Args: { p_fund_id: string }; Returns: Json };
      get_fund_summary: {
        Args: never;
        Returns: {
      ...
      update_investor_fund_performance: {
        Args: {
          p_performance_id: string;
          p_admin_id: string;
          p_mtd_beginning_balance: number;
          p_mtd_ending_balance: number;
          p_mtd_additions: number;
          p_mtd_redemptions: number;
          p_mtd_net_income: number;
          p_mtd_rate_of_return?: number;
          p_reason?: string;
        };
        Returns: Json;
      };

...
export type Database = {
  ...
  public: {
    ...
    Views: {
      ...
      v_adb_verification: {
        Row: {
          current_month_adb: number | null
          fund_code: string | null
          fund_id: string | null
          investor_email: string | null
          investor_id: string | null
          last_month_adb: number | null
          position_value: number | null
        }
        Relationships: [
          {
      ...
      v_crystallization_dashboard: {
        Row: {
          ...
          current_: number | null
          fund_code: string | null
          fund_id: string | null
          fund_name: string | null
          never_crystallized: number | null
          stale: number | null
          total_aum_in_positions: number | null
          total_positions: number | null
        }
        Relationships: []
      }
      ...
      v_merge_candidates: {
        Row: {
          ...
          merge_candidate_ids: string[] | null
      ...
      v_yield_conservation_check: {
        Row: {
          alloc_sum_gross: number | null
          distribution_id: string | null
          fund_code: string | null
          fund_id: string | null
          gross_allocation_variance: number | null
          has_violation: boolean | null
      ...
      v_yield_conservation_violations: {
        Row: {
          alloc_sum_fee: number | null
          alloc_sum_gross: number | null
          alloc_sum_ib: number | null
          alloc_sum_net: number | null
          created_at: string | null
          distribution_id: string | null
          fund_code: string | null
          fund_id: string | null

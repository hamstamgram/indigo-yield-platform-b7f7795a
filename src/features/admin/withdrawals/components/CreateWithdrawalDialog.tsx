            ...
            <Alert variant="destructive">
              ...
              <AlertDescription>
                ...
                <p className="text-sm mt-1">
                  ...
                  for this fund. Operating policy requires yield to be distributed at least every 72
                  hours before allowing new capital flows. Please run a yield drop first.
                </p>
              </AlertDescription>
            </Alert>
          )}

...
import { useInvestorOverview } from "@/hooks/data";
...
export function InvestorOverviewTab({
  ...
  if (error || !data) {
    return (
      <div className="p-4 text-center text-muted-foreground">Failed to load overview data</div>
    );
  }
        ...
        <Card className="border-dashed">
          <CardContent className="py-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-2 justify-center">
              ...
              <Button
                variant="outline"
                onClick={() => navigate(`/admin/investor-invites?investorId=${investorId}`)}
              >
    ...
    <div className="space-y-4">
        ...
        {!compact && (
          <Card className="bg-card">
            <CardContent className="p-3">
              ...
              <p className="text-sm font-medium truncate">{data.ibParentName || "None"}</p>
            </CardContent>
          </Card>
        )}
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <Button
          variant="outline"
          size="sm"
          onClick={() => navigate(`/admin/withdrawals?investorId=${investorId}`)}
        >
          ...
          <CardContent className="p-3 flex items-center gap-3">
            ...
            <div className="flex-1">
              <p className="text-sm font-medium">
                ...
                {data.pendingWithdrawals !== 1 ? "s" : ""} require attention
              </p>
              <p className="text-xs text-muted-foreground">
                Review and approve or reject these requests
              </p>
            </div>

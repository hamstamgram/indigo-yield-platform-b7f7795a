    ...
    <div className="space-y-8">
      ...
      <section id="positions-section">
        <div className="mb-4">
          ...
          <p className="text-sm text-muted-foreground">Current fund positions and balances</p>
        </div>
        <InvestorPositionsTab key={`positions-${refreshKey}`} investorId={investorId} />
      </section>
      ...
      <section id="yield-history-section">
        <InvestorYieldHistory key={`yield-history-${refreshKey}`} investorId={investorId} />
      </section>
      ...
      <section id="performance-section">
        <div className="mb-4">
          ...
          <p className="text-sm text-muted-foreground">Monthly yield and performance metrics</p>
        </div>

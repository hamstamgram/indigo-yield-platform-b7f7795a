...
import { ChevronDown, ChevronUp, Edit2, Save, X, TrendingUp, TrendingDown } from "lucide-react";
...
export function FundPositionCard({
  ...
  return (
    <Collapsible open={isExpanded} onOpenChange={setIsExpanded}>
      <Card
        className={cn("transition-all duration-200", isExpanded && "ring-2 ring-primary shadow-lg")}
      >
        {/* Collapsed Header */}

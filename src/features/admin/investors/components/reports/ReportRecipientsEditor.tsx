        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-start gap-2 p-3 bg-muted/50 rounded-md">
            ...
            <p className="text-xs text-muted-foreground">
              These email addresses will receive monthly investment reports. If no recipients are
              configured, reports will be sent to the investor's account email ({investorEmail}).
            </p>
          </div>
        </CardContent>
      </Card>
        ...
        {savedEmails.length > 0 ? (
          ...
          <div className="flex items-start gap-2 p-3 bg-muted/50 rounded-md">
            ...
            <p className="text-sm text-muted-foreground">
              No report recipients configured. Reports will be sent to the account email (
              {investorEmail}).
            </p>
          </div>
        )}

...
import { useInvestorInvite } from "@/features/investor/shared/hooks/useInvestorInvite";
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            ...
            <strong>{investor.email}</strong>. They will be able to set up their account and access
            their investor dashboard.
          </DialogDescription>
        </DialogHeader>
        <div className="space-y-4 pt-4">
          <div className="bg-muted/50 p-4 rounded-lg">
            <p className="text-sm text-muted-foreground">
              The invitation will be linked to this investor profile. When they accept and create
              their account, they will automatically have access to their portfolio data.
            </p>
          </div>

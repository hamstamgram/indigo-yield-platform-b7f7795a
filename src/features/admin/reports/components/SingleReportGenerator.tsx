...
export function SingleReportGenerator() {
  ...
  const { performanceData } = useInvestorReportData(selectedInvestor, period?.id || "");
    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex justify-end pt-4 gap-2">
          <Button variant="outline" onClick={handlePreviewEmail} disabled={isActionDisabled}>
            <Eye className="mr-2 h-4 w-4" />
            Preview Email
          </Button>

          <Button variant="outline" onClick={handleSendEmail} disabled={isActionDisabled}>
            {isSending ? (
          ...
          <Button onClick={handleGeneratePDF} disabled={isActionDisabled} className="min-w-[150px]">
            {isGenerating ? (
              <>
                <Loader2 className="mr-2 h-4 w-4 animate-spin" />
                Generating...

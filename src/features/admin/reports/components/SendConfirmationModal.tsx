    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>Review the details before sending this statement</DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 py-4">
          ...
          {isOutdated && (
            <Alert variant="destructive">
              ...
              <AlertDescription>
                The underlying data has changed since this report was generated. Please regenerate
                the report before sending.
              </AlertDescription>
            </Alert>
          )}
          ...
          <div className="space-y-2">
            ...
            {noRecipients ? (
              <Alert variant="destructive">
                ...
                <AlertDescription>
                  This investor has no email addresses configured. Please add recipients in the
                  investor profile before sending.
                </AlertDescription>
              </Alert>
            ) : (
          ...
          {!isOutdated && !noRecipients && (
            <div className="flex items-start space-x-2 pt-2 border-t">
              <Checkbox
                ...
                disabled={isSending}
              />
              <label htmlFor="confirm-send" className="text-sm leading-tight cursor-pointer">
                I confirm this report is final for {periodName} and ready to be sent to{" "}

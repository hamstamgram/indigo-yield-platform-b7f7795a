...
import { PositionResetDialog } from "@/features/admin/system/components/maintenance/PositionResetDialog";
    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Perform administrative maintenance operations</p>
        </div>

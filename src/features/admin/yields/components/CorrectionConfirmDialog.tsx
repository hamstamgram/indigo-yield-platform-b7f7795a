...
export function CorrectionConfirmDialog({
  ...
  const requiredConfirmation = isMonthClosed ? "APPLY CLOSED MONTH CORRECTION" : "APPLY CORRECTION";
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="confirmation">
              Type{" "}
              <code className="px-1 py-0.5 bg-muted rounded text-xs">{requiredConfirmation}</code>{" "}
              to confirm
            </Label>
            <Input
              id="confirmation"

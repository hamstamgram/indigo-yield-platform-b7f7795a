...
export const RPC_SIGNATURES = {
  ...
  decrypt_totp_secret: {
    name: "decrypt_totp_secret" as const,
    returnType: "string",
    returnsSet: false,
    securityDefiner: false,
    requiredParams: ["encrypted_secret"] as const,
    optionalParams: [] as const,
  },
  delete_transaction: {
  ...
  encrypt_totp_secret: {
    name: "encrypt_totp_secret" as const,
    returnType: "string",
    returnsSet: false,
    securityDefiner: false,
    requiredParams: ["secret_text"] as const,
    optionalParams: [] as const,
  },
  ensure_admin: {
  ...
  fix_cost_basis_anomalies: {
    name: "fix_cost_basis_anomalies" as const,
    returnType: "Json",
    returnsSet: false,
    securityDefiner: false,
    requiredParams: ["p_admin_id"] as const,
    optionalParams: ["p_dry_run", "p_reason"] as const,
  },
  fix_doubled_cost_basis: {
    name: "fix_doubled_cost_basis" as const,
    returnType: "Json",
    returnsSet: false,
    securityDefiner: false,
    requiredParams: [] as const,
  ...
  fix_position_metadata: {
    name: "fix_position_metadata" as const,
    returnType: "Json",
    returnsSet: false,
    securityDefiner: false,
    requiredParams: [] as const,
  ...
  log_access_event: {
    name: "log_access_event" as const,
    returnType: "string",
    returnsSet: false,
    securityDefiner: false,
    requiredParams: ["p_event", "p_user_id"] as const,
    optionalParams: [
      "p_failure_reason",
      "p_ip_address",
      "p_metadata",
  ...
  require_super_admin: {
    ...
    securityDefiner: false,
    requiredParams: ["p_operation"] as const,
    optionalParams: ["p_actor_id"] as const,
  },
  requires_dual_approval: {
  ...
  route_withdrawal_to_fees: {
    ...
    securityDefiner: false,
    requiredParams: ["p_request_id"] as const,
    optionalParams: ["p_actor_id", "p_reason"] as const,
  },
  run_comprehensive_health_check: {
  ...
  upsert_fund_aum_after_yield: {
    ...
    returnsSet: false,
    securityDefiner: false,
    requiredParams: ["p_aum_date", "p_fund_id"] as const,
    optionalParams: [
      "p_source",
      "p_total_aum",
      "p_actor_id",

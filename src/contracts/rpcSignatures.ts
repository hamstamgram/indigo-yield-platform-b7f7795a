...
export const RPC_FUNCTIONS = [
  ...
  "get_ib_referrals",
  "get_investor_all_ledger_balances",
...
export const RPC_SIGNATURES = {
  ...
  calculate_yield_allocations: {
    name: "calculate_yield_allocations" as const,
    returnType: "{",
    returnsSet: false,
    securityDefiner: false,
    requiredParams: ["p_fund_id", "p_recorded_aum"] as const,
    optionalParams: ["p_period_end"] as const,
  },
  can_access_investor: {
  ...
  check_historical_lock: {
    name: "check_historical_lock" as const,
    returnType: "boolean",
    returnsSet: false,
    securityDefiner: false,
    requiredParams: ["p_date", "p_fund_id"] as const,
  ...
  get_drift_summary: {
    name: "get_drift_summary" as const,
    returnType: "{",
    returnsSet: false,
    securityDefiner: false,
    requiredParams: [] as const,
  ...
  get_fees_account_for_fund: {
    name: "get_fees_account_for_fund" as const,
    returnType: "string",
    returnsSet: false,
    securityDefiner: false,
    requiredParams: ["p_fund_id"] as const,
  ...
  get_investor_all_ledger_balances: {
    name: "get_investor_all_ledger_balances" as const,
    returnType: "{",
    returnsSet: true,
    securityDefiner: true,
  ...
  get_investor_ledger_balance: {
    name: "get_investor_ledger_balance" as const,
    returnType: "number",
    returnsSet: false,
    securityDefiner: true,
    requiredParams: ["p_investor_id", "p_fund_id"] as const,
    optionalParams: [] as const,
  },
  get_investor_fee_pct: {
  ...
  qa_seed_world: {
    ...
    returnsSet: false,
    securityDefiner: false,
    requiredParams: ["p_run_tag"] as const,
    optionalParams: [] as const,
  },
  queue_statement_deliveries: {
  ...
  recalculate_fund_aum_for_date: {
    ...
    securityDefiner: false,
    requiredParams: ["p_fund_id"] as const,
    optionalParams: ["p_actor_id", "p_date", "p_purpose", "p_target_date"] as const,
  },
  recompute_investor_position: {
  ...
  sync_transaction_aum_after_yield: {
    name: "sync_transaction_aum_after_yield" as const,
    returnType: "undefined",
    returnsSet: false,
    securityDefiner: false,
  ...
  void_and_reissue_full_exit: {
    ...
    returnsSet: false,
    securityDefiner: false,
    requiredParams: ["p_admin_id", "p_new_amount", "p_reason", "p_transaction_id"] as const,
    optionalParams: ["p_new_date", "p_send_precision"] as const,
  },
  void_and_reissue_transaction: {
  ...
  void_completed_withdrawal: {
    name: "void_completed_withdrawal" as const,
    returnType: "Json",
    returnsSet: false,
    securityDefiner: true,
    requiredParams: ["p_reason", "p_withdrawal_id"] as const,

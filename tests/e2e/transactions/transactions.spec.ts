...
test.describe('Transactions Page - /transactions', () => {
  ...
  test('should display transactions table', async ({ page }) => {
    try {
      ...
      const hasDateHeader = await helpers.elementExists('th:has-text("Date"), th:has-text("Created")');
  ...
  test('should test filter functionality', async ({ page }) => {
    ...
    const filterButtons = await page.$$('button:has-text("Filter"), button:has-text("Type"), button:has-text("Status")');
  ...
  test('should test date range filter', async ({ page }) => {
    ...
    const datePicker = await page.$('input[type="date"], button:has-text("Date"), [data-date-picker]');
  ...
  test('should display transaction types correctly', async ({ page }) => {
    ...
    const hasTypes = await helpers.elementExists(
  ...
  test('should navigate to transaction details', async ({ page }) => {
    ...
    const transactionLinks = await page.$$('tr[data-href], a[href*="transaction"], button:has-text("View")');
  ...
  test('should have new transaction button', async ({ page }) => {
    ...
    const newTransactionButton = await page.$('button:has-text("New"), button:has-text("Deposit"), a[href*="deposit"]');

...
test.describe('Deposit Page - /transactions/deposit', () => {
  ...
  test('should have fund/asset selector', async ({ page }) => {
    ...
    const fundSelector = await page.$('select[name*="fund"], [role="combobox"], button:has-text("Select Fund")');
  ...
  test('should validate amount field', async ({ page }) => {
    ...
    if (amountInput) {
      ...
      const submitButton = await page.$('button[type="submit"], button:has-text("Submit"), button:has-text("Deposit")');
      if (submitButton) {
  ...
  test('should show minimum deposit requirement', async ({ page }) => {
    const hasMinimum = await helpers.elementExists(
      'text=Minimum, text=minimum, text=Min'
    );
  ...
  test('should have recurring deposit option', async ({ page }) => {
    ...
    const recurringOption = await page.$('input[type="checkbox"][name*="recurring"], [role="switch"]');
  ...
  test('should display fee information', async ({ page }) => {
    const hasFeeInfo = await helpers.elementExists(
      'text=Fee, text=Charge, text=Processing Fee'
    );
  ...
  test('should have notes or memo field', async ({ page }) => {
    const notesField = await page.$('textarea[name*="note"], textarea[name*="memo"], input[name*="description"]');
  ...
  test('should have submit button', async ({ page }) => {
    const submitButton = await page.$('button[type="submit"], button:has-text("Submit"), button:has-text("Deposit"), button:has-text("Continue")');
  ...
  test('should have cancel button', async ({ page }) => {
    const cancelButton = await page.$('button:has-text("Cancel"), a:has-text("Cancel"), button:has-text("Back")');
  ...
  test('should show deposit limits', async ({ page }) => {
    const hasLimits = await helpers.elementExists(
      'text=Limit, text=Maximum, text=Max'
    );

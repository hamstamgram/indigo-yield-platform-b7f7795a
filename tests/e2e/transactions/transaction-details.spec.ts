...
test.describe('Transaction Details Page - /transactions/:id', () => {
  ...
  test('should have back button or navigation', async ({ page }) => {
    ...
    const backButton = await page.$('button:has-text("Back"), a:has-text("Back"), [aria-label*="Back"]');
  ...
  test('should have action buttons', async ({ page }) => {
    ...
    const actionButtons = await page.$$('button:has-text("Download"), button:has-text("Print"), button:has-text("Cancel")');
  ...
  test('should display fee information if applicable', async ({ page }) => {
    ...
    const hasFees = await helpers.elementExists(
      'text=Fee, text=Charge, text=Commission'
    );

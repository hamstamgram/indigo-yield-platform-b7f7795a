...
async function addTransaction(
  ...
  // crystallize_yield_before_flow is expensive: loops investors, generates daily series, falls back to tx sums.
  // Use 600s (10min) timeout to accommodate complex yield crystallization across investor base & history.
  await waitForToast(page, label, opts.fullExit ? 600000 : 45000);

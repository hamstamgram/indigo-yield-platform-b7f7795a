...
-- ROLLBACK:
-- DROP TRIGGER IF EXISTS trg_documents_sync_profile_ids ON documents;
-- DROP FUNCTION IF EXISTS sync_documents_profile_ids();
-- ALTER TABLE documents DROP CONSTRAINT IF EXISTS fk_documents_created_by_profile;
-- ALTER TABLE documents DROP CONSTRAINT IF EXISTS fk_documents_user_profile;
-- ALTER TABLE documents DROP COLUMN IF EXISTS created_by_profile_id;
-- ALTER TABLE documents DROP COLUMN IF EXISTS user_profile_id;
-- ============================================================================

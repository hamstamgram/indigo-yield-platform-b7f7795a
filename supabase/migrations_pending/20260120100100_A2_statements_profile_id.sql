...
-- ROLLBACK:
-- DROP TRIGGER IF EXISTS trg_statements_sync_profile_id ON statements;
-- DROP FUNCTION IF EXISTS sync_statements_investor_profile_id();
-- ALTER TABLE statements DROP CONSTRAINT IF EXISTS fk_statements_investor_profile;
-- ALTER TABLE statements DROP COLUMN IF EXISTS investor_profile_id;
-- ============================================================================

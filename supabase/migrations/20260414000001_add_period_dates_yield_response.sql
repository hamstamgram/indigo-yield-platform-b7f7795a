...
-- Frontend reads result.period_start and result.period_end in yieldApplyService.ts:97-98
-- Evidence: docs/audit/37-frontend-backend-contract-mismatch-matrix.md P1-1

DROP FUNCTION IF EXISTS public.apply_segmented_yield_distribution_v5(uuid, date, numeric, uuid, aum_purpose, date, numeric);

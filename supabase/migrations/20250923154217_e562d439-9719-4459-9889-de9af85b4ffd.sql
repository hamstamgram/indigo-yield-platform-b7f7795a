-- Fixed migration with correct admin function
  ...
  LOOP
    BEGIN
      ...
      INSERT INTO public.investor_positions (
        ...
        v_fund_id,
        'A',
        v_position.current_balance, -- Using balance as shares for now
      ...
      INSERT INTO public.transactions_v2 (
        ...
        v_position.principal,
        1.0, -- Assuming 1:1 for stablecoins, will need price data for others
        v_position.principal,
...
-- 2. Create function to generate statements for all investors
...
-- 3. Create function to populate yield sources

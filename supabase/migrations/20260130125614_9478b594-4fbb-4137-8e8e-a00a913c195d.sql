-- Fix void_fund_daily_aum to set is_voided = true on yield_distributions
-- First fix existing data, then update the function

-- Part 1: Fix existing data with canonical flag set
DO $$
BEGIN
...
-- Part 2: Update the void_fund_daily_aum function to set is_voided = true

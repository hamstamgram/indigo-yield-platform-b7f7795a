-- Migration: Fix apply_investor_transaction canonical rpc guard
-- Date: 2026-03-05
-- Context: apply_investor_transaction was failing the canonical mutation trigger guard
-- because it did not set the indigo.canonical_rpc configuration session variable.

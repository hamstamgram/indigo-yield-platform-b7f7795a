-- Fix: void_transaction calls recalculate_fund_aum_for_date with 4 args
-- but the function only accepts 2 args (p_fund_id, p_target_date).
-- The silent EXCEPTION handler hides this mismatch, causing AUM snapshot desync after voids.
...
BEGIN
  ...
  -- FIX: Call with correct 2-arg signature (was 4 args, causing silent failure)
  BEGIN
  ...
  -- CASCADE: DUST_SWEEP transactions

-- Fix apply_daily_yield_to_fund_v3 to match actual yield_distributions schema
-- The table has: gross_yield, net_yield, total_fees, total_ib, investor_count, opening_aum, closing_aum, yield_percentage
-- NOT: investor_id, gross_yield_amount, fee_percentage, fee_amount, net_yield_amount, etc.
...
BEGIN
  ...
  LOOP
    ...
    INSERT INTO transactions_v2 (
      fund_id, investor_id, type, amount, tx_date, 
      reference_id, description, created_by
    ) VALUES (
      p_fund_id, v_investor.investor_id, 'YIELD', v_net_yield, p_yield_date,
    ...
    IF v_fee_amount > 0 THEN
      INSERT INTO transactions_v2 (
        ...
        p_fund_id, v_fees_account_id, 'FEE', v_fee_amount, p_yield_date,
    ...
    IF v_ib_amount > 0 AND v_investor.ib_parent_id IS NOT NULL THEN
      INSERT INTO transactions_v2 (
        ...
        p_fund_id, v_investor.ib_parent_id, 'IB_CREDIT', v_ib_amount, p_yield_date,

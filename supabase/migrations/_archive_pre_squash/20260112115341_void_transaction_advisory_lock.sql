-- Security remediation: Add advisory lock to get_void_transaction_impact
-- Ensures preview function acquires the same lock as void_transaction
-- to prevent reading stale data during concurrent void operations
...
Uses same advisory lock key: hashtext(''void:'' || transaction_id)
to ensure consistent read during concurrent void operations.';

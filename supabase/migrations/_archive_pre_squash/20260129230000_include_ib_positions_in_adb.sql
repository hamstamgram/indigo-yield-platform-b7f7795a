-- Include IB positions in ADB-based yield distributions so IB credits become fund ownership.
...
BEGIN
  ...
  RETURN jsonb_build_object(
    ...
    'features', ARRAY['time_weighted', 'loss_carryforward', 'fee_credit', 'ib_commission', 'latest_period_reporting', 'ib_positions_in_adb']
  );
END;
$function$;

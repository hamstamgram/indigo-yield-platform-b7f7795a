-- Fix void_transaction function: remove invalid updated_at column reference
-- The transactions_v2 table does not have an updated_at column
...
BEGIN
  ...
  -- Update transaction to voided (removed invalid updated_at reference)

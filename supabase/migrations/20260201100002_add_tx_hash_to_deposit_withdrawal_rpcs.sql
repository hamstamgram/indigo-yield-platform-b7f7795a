-- Migration: Add p_tx_hash and p_tx_subtype to deposit and withdrawal RPCs
-- This allows tx_hash from the admin deposit form to be persisted on the transaction

-- ============================================================================
-- PHASE 3A: Void Dependency Check - Detect yields affected by voided transaction
-- ============================================================================
...
BEGIN
  ...
  -- ============================================================================
  -- NEW: Check for yields calculated AFTER this transaction's effective date
  -- These yields may have used this transaction's amount in AUM calculations
  -- ============================================================================
  ...
  IF array_length(v_dependent_yields, 1) > 0 THEN
    ...
    -- Log the yield dependency warning for visibility
  ...
  -- Recompute investor position from raw ledger (atomic truth)

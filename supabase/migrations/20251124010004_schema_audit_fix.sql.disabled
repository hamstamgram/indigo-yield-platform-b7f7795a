...
DROP POLICY IF EXISTS "Allow read access to fund_configurations" ON public.fund_configurations;
...
DROP POLICY IF EXISTS "Allow admin write access to fund_configurations" ON public.fund_configurations;
...
DROP POLICY IF EXISTS "Investors can read own positions" ON public.investor_positions;
...
DROP POLICY IF EXISTS "Admins can read all positions" ON public.investor_positions;
...
DROP POLICY IF EXISTS "Investors can read own transactions" ON public.transactions_v2;

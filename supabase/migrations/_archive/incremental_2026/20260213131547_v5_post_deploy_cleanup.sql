...
-- Note: fee_allocations table doesn't have debit_transaction_id, voided_at, or voided_by columns
...
WHERE fa.is_voided = false
  AND (yd.id IS NULL OR yd.status = 'voided'::yield_distribution_status);

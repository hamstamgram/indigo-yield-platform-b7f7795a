...
-- ============================================================================
-- FIX 2a: Add 'transaction' and 'preflow' to fund_aum_events trigger_type CHECK
-- SKIPPED: Table fund_aum_events does not exist in current schema
-- ============================================================================
DO $$
BEGIN
  -- Only run if table exists
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'fund_aum_events' AND table_schema = 'public') THEN
...
-- Uses 'amount' column (not processed_amount which doesn't exist in current schema)
-- ============================================================================

...
-- Ensure column exists when the table was created previously without it
ALTER TABLE email_logs ADD COLUMN IF NOT EXISTS sent_by UUID REFERENCES profiles(id);

ALTER TABLE email_logs ADD COLUMN IF NOT EXISTS recipient_name TEXT;
ALTER TABLE email_logs ADD COLUMN IF NOT EXISTS report_month DATE;
ALTER TABLE email_logs ADD COLUMN IF NOT EXISTS external_id TEXT;

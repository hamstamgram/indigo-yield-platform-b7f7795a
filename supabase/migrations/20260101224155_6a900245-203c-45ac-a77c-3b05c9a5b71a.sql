-- Fix force_delete_investor 2-arg function: remove references to non-existent tables
-- Removes: investments, portfolio_history
...
BEGIN
  ...
  -- Transaction and position tables (REMOVED: investments, portfolio_history - tables do not exist)

-- Add 'route_to_fees' to withdrawal_action enum
ALTER TYPE public.withdrawal_action ADD VALUE IF NOT EXISTS 'route_to_fees';

-- Recreate the function to ensure it picks up the new enum value
...
BEGIN
  ...
  -- Log the action with the now-valid enum value

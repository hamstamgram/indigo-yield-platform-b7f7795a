-- PHASE 1: Complete Platform Remediation - Database Schema Normalization & Security (Fixed)
...
-- =============================================
-- Step 6: Create Sample Fund Data (skip assets_v2 for now)
-- =============================================
...
BEGIN
    ...
    -- Count investors and positions
    SELECT COUNT(*) INTO investor_count FROM public.investors;
    SELECT COUNT(*) INTO position_count FROM public.investor_positions;
    ...
    RAISE NOTICE '   - Investor positions: %', position_count;

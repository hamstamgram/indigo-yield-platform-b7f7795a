...
-- The RPC was inserting distribution_type = 'month_end' which is not in the allowed list
-- for rows without a parent_distribution_id. Change to 'original' which is correct.

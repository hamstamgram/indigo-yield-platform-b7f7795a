-- Continue Phase 1: Populate remaining v2 schema tables

-- 1) Create investor positions from legacy positions data
...
-- 2) Create yield sources from positions for yield distribution
...
-- 3) Set up initial yield rates for all assets
...
-- 4) Create system configuration for yield platform

-- Fix force_delete_investor: Remove invalid statement_metadata table reference
-- The statement_metadata table does not exist in the database
...
BEGIN
  ...
  -- Statement tables (removed statement_metadata - table does not exist)

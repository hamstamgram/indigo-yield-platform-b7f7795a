-- Fixed migration using valid fund_class values from funds table
...
-- Create investor positions using existing fund classes
...
SELECT 
  i.id,
  f.id,
  f.fund_class, -- Use actual fund_class from funds table

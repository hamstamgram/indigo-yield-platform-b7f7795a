/**
 * Statement Template - Edge Function version matching exact email template format
 */
...
export const COMPANY_LOGO = 'https://storage.mlcdn.com/account_image/325398/nBu3JuQaeiX2mp3ehXrrmQIKWMXijbAz6hU3Rffd.png';
          ...
          <tr>
            <td style="padding-bottom:24px;">
              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td>
                    <img src="${COMPANY_LOGO}" alt="Indigo Funds" height="40" style="display:block;">
                  </td>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
                  <td style="text-align:center;padding-bottom:8px;">
                    <span style="font-size:12px;color:#64748b;">© ${currentYear} Indigo Funds. All rights reserved.</span>
                  </td>
                </tr>
                <tr>

...
BEGIN
  ...
  -- Check 13: audit_log_for_distributions (FIXED: also match entity='yield_distributions')
  ...
  -- Check 15: no_invalid_admin_accounts (FIXED: exclude fees_account)
  ...
  -- Check 16: no_orphan_auth_users (FIXED: exclude test users)
  WITH orphans AS (

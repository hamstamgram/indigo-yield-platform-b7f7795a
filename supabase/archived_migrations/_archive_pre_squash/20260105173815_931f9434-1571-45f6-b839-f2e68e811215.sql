-- Fix parameter name mismatch - frontend uses p_yield_date, not p_target_date
-- Drop all v3 versions and recreate with correct parameter name
...
-- ============================================
-- FIX preview_daily_yield_to_fund_v3 with correct param name
-- ============================================
...
-- ============================================
-- FIX apply_daily_yield_to_fund_v3 with correct param name
-- ============================================

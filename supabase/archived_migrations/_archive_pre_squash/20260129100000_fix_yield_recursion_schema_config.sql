-- Fix: Restores apply_adb_yield_distribution_v3 implementation to resolve recursion and mismatched columns
-- Issues Fixed:
-- 1. Recursion: v3 was calling deleted v1, or v1 calling v3 loop. Consolidated logic into v3.
-- 2. Schema Mismatch: Updated column names (net_yield_amount -> total_net_amount, etc.) to match table.
-- 3. Trigger Block: Updated config key from 'app.canonical_rpc' to 'indigo.canonical_rpc' to bypass is_canonical_rpc().

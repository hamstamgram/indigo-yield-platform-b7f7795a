...
//  IndigoInvestor
//
//  Screen 34/85: Confirm withdrawal
//
...
struct WithdrawalConfirmationView: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle("Confirm withdrawal")
...
private struct ContentView: View {
    @ObservedObject var viewModel: WithdrawalConfirmationViewModel

    var body: some View {
        VStack(spacing: 20) {
            // TODO: Implement screen-specific content
            Text("Content for WithdrawalConfirmationView")

...
//  IndigoInvestor
//
//  Screen 45/85: Upload documents with scanner
//
...
struct DocumentUploadView: View {
    ...
    var body: some View {
        NavigationStack {
            ZStack {
                ...
                ScrollView {
                    VStack(spacing: 24) {
                        // Header
                        VStack(spacing: 12) {
                            Text("Upload documents with scanner")
            ...
            .navigationTitle("Upload documents with scanner")
...
private struct ContentView: View {
    ...
    var body: some View {
        VStack(spacing: 20) {
            ...
            Text("Content for DocumentUploadView")

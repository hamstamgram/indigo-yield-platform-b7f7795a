...
//  IndigoInvestor
//
//  Screen 70/85: Single notification detail
//
...
struct NotificationDetailView: View {
    ...
    var body: some View {
        NavigationStack {
            ZStack {
                ...
                ScrollView {
                    VStack(spacing: 24) {
                        // Header
                        VStack(spacing: 12) {
                            Text("Single notification detail")
            ...
            .navigationTitle("Single notification detail")
...
private struct ContentView: View {
    ...
    var body: some View {
        VStack(spacing: 20) {
            ...
            Text("Content for NotificationDetailView")
